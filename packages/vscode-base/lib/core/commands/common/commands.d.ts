...
import { TypeConstraint } from "../../base/common/type";
...
export declare const ICommandService: import("../../instantiation/common/instantiation").ServiceIdentifier<ICommandService>;
